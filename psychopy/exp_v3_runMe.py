...
for run_num in range(run_num, 7):
    if run_num == 3 or run_num == 6:
        ...
        filename = _thisDir + '/data/' + str(participant) + '/' + 'exp_v3' + '/' + str(experiment_info_header)
    ...
    # ====== Generate parfiles for runs  =============
        ...
        output_parfile_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v3' + '/' + 'run' + str(run_num) + '.par'
        ...
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v3' + '/' + 'script_babyloc_static_newexp_run' + str(run_num) + '.csv'
    ...
    # ====== Generate parfiles for dynamic exp_v3 runs  =============
        # Create an empty list to store parfile data
        par_file_data = []
        ...
        # Define the path to the exp folder
        output_parfile_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v3' + '/' + 'run' + str(run_num) + '.par'
