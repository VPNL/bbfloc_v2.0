...
for run_num in range(run_num, 7):
    if run_num == 2 or run_num == 5:
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + 'script_saxe_newexp_run' + str(run_num) + '.csv'
        par_file_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + 'saxe_parfile_for_run' + str(run_num) + '.csv'
        ...
        filename = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + str(experiment_info_header)
    ...
    # ====== Generate parfiles for runs  =============
        ...
        output_parfile_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + 'run' + str(run_num) + '.par'
        ...
        # ======================== experiment set-up ============================ 
        # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + 'script_babyloc_static_newexp_run' + str(run_num) + '.csv'
    ...
    # Dynamically generate the file path based on run number
        csv_file_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + 'script_babyloc_dyna_newexp_run' + str(run_num) + '.csv'
    ...
    # ====== Generate parfiles for dynamic exp_v2 runs  =============
        # Create an empty list to store parfile data
        par_file_data = []
        ...
        # Define the path to the exp_v2 folder
        output_parfile_path = _thisDir + '/data/' + str(participant) + '/' + 'exp_v2' + '/' + 'run' + str(run_num) + '.par'
