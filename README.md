...
Experiment runs are always generated in Matlab and are unique to each subject. Experiments run on PsychoPy. There's three versions of the PsychoPy runME script, each version corresponds to different run orders to prevent order bias. 
